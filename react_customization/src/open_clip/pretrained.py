...
# REACT pretrained models
_VITB32['react_clip_ret_laion400m'] = _pcfg(hf_hub='react-vl/react-in1k/clip-vit-base-32-locked-text.pt')
_VITB32['react_openclip_laion400m_ret_laion400m'] = _pcfg(hf_hub='react-vl/react-in1k/openclip-vit-base-32-locked-text.pt')
_VITB32['react_openclip_laion2b_ret_laion400m'] = _pcfg(hf_hub='react-vl/react-in1k/openclip-laion2b-vit-base-32-locked-text.pt')

_react_VITB32 = dict(
    react_clip_ret_laion400m=_pcfg(hf_hub='react-vl/react-in1k/clip-vit-base-32-gated-image.pt'),
    react_openclip_laion400m_ret_laion400m=_pcfg(hf_hub='react-vl/react-in1k/openclip-vit-base-32-gated-image.pt'),
    react_openclip_laion2b_ret_laion400m=_pcfg(hf_hub='react-vl/react-in1k/openclip-laion2b-vit-base-32-gated-image.pt'),
)

_VITB16['react_clip_ret_laion400m'] = _pcfg(hf_hub='react-vl/react-in1k/clip-vit-base-16-locked-text.pt')

_react_VITB16 = dict(
    react_clip_ret_laion400m=_pcfg(hf_hub='react-vl/react-in1k/clip-vit-base-16-gated-image.pt'),
)

_react_VITL14 = dict(
    react_clip_ret_laion400m=_pcfg(hf_hub='react-vl/react-in1k/clip-vit-large-14-gated-image.pt'),
    react_clip_ret_laion2b=_pcfg(hf_hub='react-vl/react-in1k/clip-vit-large-14-gated-image-laion2b.pt'),
    react_openclip_laion2b_ret_laion400m=_pcfg(
        hf_hub='react-vl/react-in1k/openclip-vit-large-14-gated-image.pt',
        mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5)),
    react_openclip_laion2b_ret_laion2b=_pcfg(
        hf_hub='react-vl/react-in1k/openclip-vit-large-14-gated-image-laion2b.pt',
        mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5)),
)

_react_VITbigG14 = dict(
    react_openclip_laion2b_ret_laion2b=_pcfg(hf_hub='react-vl/react-in1k/openclip-vit-bigG-14-gated-image-laion2b.pt'),
)
...
_PRETRAINED = {
    ...
    "react_ViT-B-32": _react_VITB32,
    "react_ViT-B-16": _react_VITB16,
    "react_ViT-L-14": _react_VITL14,
    "react_ViT-bigG-14": _react_VITbigG14,
    "ViT-H-14": _VITH14,
    "ViT-g-14": _VITg14,
